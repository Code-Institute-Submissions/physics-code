function initMap() {
  ...
  let intersection_one = {lat: 55.777034, lng: 37.583926};
  let intersection_two = {lat: -33.738541, lng: 150.917933};
  let intersection_three = {lat: 39.060609, lng: -77.459229};
  let intersection_four = {lat: 49.453656, lng: 11.015989};
  let intersection_five = {lat: 53.354385, lng: -6.273174};
  ...
  let marker = new google.maps.Marker({position: intersection_one, map: map,  icon: image});
  ...
  let marker2 = new google.maps.Marker({position: intersection_two, map: map2,  icon: image});
  ...
  let marker3 = new google.maps.Marker({position: intersection_three, map: map3,  icon: image});
  ...
  let marker4 = new google.maps.Marker({position: intersection_four, map: map4,  icon: image});
  ...
  let marker5 = new google.maps.Marker({position: intersection_five, map: map5,  icon: image});

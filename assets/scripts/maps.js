function initMap() {
  ...
  let intersection_two = {
    lat: -33.738541,
    lng: 150.917933
  };
  let intersection_three = {
    lat: 39.060609,
    lng: -77.459229
  };
  let intersection_four = {
    lat: 49.453656,
    lng: 11.015989
  };
  let intersection_five = {
    lat: 53.354385,
    lng: -6.273174
  };
  ...
  let map3 = new google.maps.Map(
    document.getElementById('map_three'), {
      zoom: 19,
      center: intersection_three,
      mapTypeId: 'satellite',
      zoomControl: false,
      rotateControl: false
    });
  let map4 = new google.maps.Map(
    document.getElementById('map_four'), {
      zoom: 19,
      center: intersection_four,
      mapTypeId: 'satellite',
      zoomControl: false,
      rotateControl: false
    });
  let map5 = new google.maps.Map(
    document.getElementById('map_five'), {
      zoom: 19,
      center: intersection_five,
      mapTypeId: 'satellite',
      zoomControl: false,
      rotateControl: false
    });
